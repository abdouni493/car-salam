  ...
  getAuthHeaders(): Record<string, string> {
    ...
    try {
      ...
      return {
        ...
        'apikey': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhwbnF5aW1tZnhsbHF1YWNjdW9hIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODM0MzEzNDQsImV4cCI6MjA5OTAwNzM0NH0.YZdJVzX154AhIJGImjtCYWYSGFc2RyC_40IHXrxSbPQ'
      };
    } catch {
      return {};
    }
