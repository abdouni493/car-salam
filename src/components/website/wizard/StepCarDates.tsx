      ...
      <div className="space-y-8">
        ...
        <div className="relative flex items-center max-w-xl mx-auto">
          ...
          <input
            ...
            style={{ background: C.elevated, border: '1px solid rgba(200, 16, 46, 0.16)' }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {filteredCars.map((c, i) => (
              <motion.button
                ...
                onMouseEnter={e => {
                  (e.currentTarget as HTMLElement).style.borderColor = 'rgba(200, 16, 46, 0.28)';
                  (e.currentTarget as HTMLElement).style.boxShadow = '0 0 30px rgba(200, 16, 46, 0.08)';
                }}
                onMouseLeave={e => {
              ...
              >
                <div className="h-40 overflow-hidden relative" style={{ background: C.surface }}>
                  ...
                  <div className="absolute top-3 left-3 px-2 py-0.5 rounded-lg text-xs font-bold"
                    style={{ background: 'rgba(200, 16, 46, 0.1)', border: '1px solid rgba(200, 16, 46, 0.25)', color: C.accent, fontFamily: 'var(--font-display)' }}>
                    {c.year}
                  </div>
                </div>
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-black text-lg" style={{ color: C.accent, fontFamily: 'var(--font-display)' }}>
                        ...
                        <span className="text-xs ml-1" style={{ color: 'rgba(200, 16, 46, 0.75)' }}>
                    ...
                    <div className="w-8 h-8 rounded-xl flex items-center justify-center"
                      style={{ background: 'rgba(200, 16, 46, 0.09)', border: '1px solid rgba(200, 16, 46, 0.25)' }}>
        ...
        {days > 0 && (
          ...
          >
            ...
            <span className="text-vel-slate font-bold text-sm">
              ...
              {promo && (
                <span className="ml-2 text-xs px-2 py-0.5 rounded font-bold text-vel-black" style={{ background: 'var(--color-vel-cta)' }}>
