  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8" style={{ background: C.bg }}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-[600px] h-[600px]" style={{ background: 'radial-gradient(circle, rgba(234, 88, 12, 0.04), transparent 70%)', transform: 'translate(30%, -30%)' }} />
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px]" style={{ background: 'radial-gradient(circle, rgba(234, 88, 12, 0.05), transparent 70%)', transform: 'translate(-30%, 30%)' }} />
      </div>
                ...
                <React.Fragment key={n}>
                    ...
                    <motion.div
                      ...
                      style={{
                        background: isCompleted
                          ...
                          : isCurrent
                          ? 'linear-gradient(135deg, rgba(234, 88, 12, 0.16), rgba(234, 88, 12, 0.18))'
                          : 'rgba(15, 23, 42, 0.05)',
                        border: isCompleted || isCurrent ? '2px solid var(--color-vel-cta)' : '2px solid rgba(15, 23, 42, 0.12)',
                        boxShadow: isCurrent ? '0 0 20px rgba(234, 88, 12, 0.25)' : 'none',
                  ...
                  {n < WIZARD_STEP_COUNT && (
                    <div className="flex-1 max-w-16 h-0.5 mx-1.5 sm:mx-3 mt-5 rounded-full transition-all duration-700"
                      style={{ background: step > n ? 'linear-gradient(90deg, var(--color-vel-cta), var(--color-vel-cta-deep))' : 'rgba(15, 23, 42, 0.06)' }}
                    />
                  )}
                </React.Fragment>
              );
