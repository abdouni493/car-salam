              ...
              return (
                <motion.button
                  ...
                  style={{
                    ...
                    border: isSelected ? '1px solid rgba(200, 16, 46, 0.5)' : '1px solid rgba(255, 255, 255, 0.06)',
                    boxShadow: isSelected ? '0 0 30px rgba(200, 16, 46, 0.1)' : 'none',
                  }}
                >
                  ...
                  <div className="p-5 flex items-start justify-between gap-3"
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0"
                        style={{ background: 'rgba(200, 16, 46, 0.09)', border: '1px solid rgba(200, 16, 46, 0.2)' }}>
                    ...
                    <div className="w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300"
                      style={{
                        ...
                        border: isSelected ? `2px solid ${C.accent}` : '2px solid rgba(255, 255, 255, 0.15)',
                      }}>
                        ...
                        {a.items.map(item => (
                          <li key={item.linkId || item.itemId} className="flex items-center gap-2 text-sm">
                            <span className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${
                              item.status ? 'bg-green-100 text-green-600' : 'bg-vel-ink/10 text-vel-ink'
                            }`}>
                  ...
                  {days > 0 && (
                    <div className="px-5 py-3 flex items-center justify-between text-xs"
                      style={{ background: 'rgba(200, 16, 46, 0.04)', borderTop: '1px solid rgba(255, 255, 255, 0.06)' }}>
